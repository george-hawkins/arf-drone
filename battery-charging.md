...
_Sensor displaying cell voltages._<br><img width="512" src="images/assembly/charging/battery-voltage.jpg">
...
_Battery alarm._<br><img width="256" src="images/assembly/charging/battery-alarm.jpg">
...
Always connect the charger lead (with the banana plugs) to the charger before connecting it to the battery.

_Charger and charger lead._  
<img height="512" src="images/assembly/charging/charger-and-lead.jpg">

Doing things in his order is more important than it seems - the easiest way to permanently damage your battery (and potentially cause an explosion and fire) is to short it - and probably the easiest way to short it is to first connect the charger lead to the battery, rather than the charger, and then accidentally knock together the banana plugs of the charger lead. Why charger manufacturers standardized on male banana plugs for charger leads, making this kind of accident very easy, is a mystery.

Then connect the battery to the charger - the battery must be connected via both leads to the charger as shown.

_Charger connected to battery._<br><img height="512" src="images/assembly/charging/charger-to-battery.jpg">
...
When I power on my charger it starts straight into "LiPo balance" mode and shows 2.0A and 14.8V(4S). My battery is 4S so that's already perfect but it's a 3700mAh battery so I need to increase the amps to 3.7A (see later for more on this). Your battery may be different so make sure to check its mAh value. To change this I just need to press ENTER, press INC until 3.7A is shown and then press ENTER twice (so no value is blinking any longer).

Now you're ready to start charging - you should keep the battery in a LiPo safety bag for the duration of the charging.

_Ready to start charging._<br><img height="512" src="images/assembly/charging/ready-to-charge.jpg">

Press and hold the ENTER button for 3 seconds, the charger will check the battery - it shows an R and an S value, you should confirm these are both the same value and match your battery (4S) - if all is correct press ENTER again.
