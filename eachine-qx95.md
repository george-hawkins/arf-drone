...
So I thought I'd buy a low end [BNF](https://www.modelflight.com.au/blog/difference-between-rtf-bnf-pnp-arf/) drone that I could control with the same transmitter I intended to use with my main build and which I could learn to fly with without worrying too much about crashing it. Until recently you just couldn't get small cheap BNF drones that you could control out of the box with FrSKY transmitters like the Q X7 or the X9D+ but this has started to change.
...
There are two spare motors - a clockwise (CW) and counterclockwise (CCW) one - and a set of replacement propellars along with a small plastic wrench for removing propellars.
...
_QX95 with unused Gemfan propellar_  
