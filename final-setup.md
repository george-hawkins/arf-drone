...
We don't have to do anything to set up audio alerts for low and critical RSSI values - this is done automatically. If you were looking carefully on the _Telemetry_ screen you'd have seen the _Low alarm_ and _Critical alarm_ values for RSSI - the defaults seem to be good (45 and 42 respectively). Some people set the critical alarm lower.

TODO: move bit about seeing where RTL kicks in here.
